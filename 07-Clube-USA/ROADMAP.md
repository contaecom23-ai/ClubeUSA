...
- [x] **0.1** Cadastro + perfil mínimo + email confirmado — PR #X — backend FastAPI (register/login/confirm-email/refresh/profile), migrations SQL, frontend HTML, 19 testes passando
