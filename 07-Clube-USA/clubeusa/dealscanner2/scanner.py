...
def scan_amazon(existing_ids):
    ...
    if not config.AMAZON_ACCESS_KEY or not config.AMAZON_SECRET_KEY or "SUA_ACCESS_KEY" in config.AMAZON_ACCESS_KEY:
        log.info("Amazon: credenciais nao configuradas. Pulando.")
        return new_deals
